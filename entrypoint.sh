...
# Start the Django development server on all network interfaces, listening on port 8010
echo -e "${bold}${blue}Starting Django development server...${normal}"
echo -e "${bold}${blue}Access the application at${normal} ${bold}${red}http://127.0.0.1:8010/${normal}"
