    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=255, unique=True, verbose_name='Name (English)')),
                ('name_jpn', models.CharField(max_length=255, unique=True, verbose_name='Name (Japanese)')),
                ('name_rom', models.CharField(blank=True, max_length=255, unique=True, verbose_name='Name (Romaji)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_list_users', models.IntegerField(blank=True, null=True, verbose_name='Number of List Users')),
                ('num_scoring_users', models.IntegerField(blank=True, null=True, verbose_name='Number of Scoring Users')),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='persons.author')),
                ('demographic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='categories.demographic')),
                ('genres', models.ManyToManyField(blank=True, to='categories.genre')),
                ('themes', models.ManyToManyField(blank=True, to='categories.theme')),
            ],
            options={
