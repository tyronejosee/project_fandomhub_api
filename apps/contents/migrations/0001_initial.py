    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=apps.utils.paths.image_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'webp']), apps.utils.validators.ImageSizeValidator(max_height=1280, max_width=909), apps.utils.validators.FileSizeValidator(limit_mb=2)], verbose_name='image')),
                ...
                ('genres', models.ManyToManyField(blank=True, to='categories.genre')),
                ('season', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='categories.season')),
                ('studio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='categories.studio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release', models.DateField(blank=True, null=True, verbose_name='release')),
                ('media_type', models.CharField(choices=[('pending', 'Pending'), ('manga', 'Manga'), ('novel', 'Novel'), ('oneshot', 'One Shot'), ('doujinshi', 'Doujinshi'), ('manhwa', 'Manhwa'), ('oel', 'OEL')], default='pending', max_length=10, verbose_name='media type')),
                ...
                ('favorites', models.IntegerField(blank=True, default=0, null=True, verbose_name='favorites')),
                ('num_list_users', models.IntegerField(blank=True, default=0, null=True, verbose_name='number of list users')),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='persons.author', verbose_name='author')),
                ('demographic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='categories.demographic', verbose_name='demographic')),
                ('genres', models.ManyToManyField(blank=True, to='categories.genre', verbose_name='genres')),
                ('themes', models.ManyToManyField(blank=True, to='categories.theme', verbose_name='themes')),
            ],
            options={
                'verbose_name': 'manga',
